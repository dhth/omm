...
- New themes: `gruvbox-dark-hard`, `gruvbox-light`

### Changes

- The TUI now applies the active theme's background color to the entire terminal
...
[unreleased]: https://github.com/dhth/omm/compare/v0.7.0...HEAD
[v0.7.0]: https://github.com/dhth/omm/compare/v0.6.0...v0.7.0
